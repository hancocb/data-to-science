...
Revision ID: 6fc010b1a2f7
Revises: 884e43c58053
Create Date: 2025-09-10 16:42:46.082015
...
def upgrade() -> None:
    ...
    op.create_geospatial_table('annotations',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('description', sa.Text(), nullable=False),
    sa.Column('geom', Geometry(srid=4326, spatial_index=False, from_text='ST_GeomFromEWKT', name='geometry', nullable=False), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"), nullable=False),
    ...
    op.create_geospatial_index('idx_annotations_geom', 'annotations', ['geom'], unique=False, postgresql_using='gist', postgresql_ops={})
    op.create_index(op.f('ix_annotations_data_product_id'), 'annotations', ['data_product_id'], unique=False)
    op.create_table('annotation_attachments',
    sa.Column('id', sa.UUID(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_geospatial_index('idx_annotations_geom', table_name='annotations', postgresql_using='gist', column_name='geom')
