...
\footnotemark[1]{NDVI = Normalized Difference Vegetation Index}
\footnotemark[2]{ExG = Excess Green Vegetation Index}
\footnotemark[3]{VARI = Visual Atmospherically Resistant Index}
